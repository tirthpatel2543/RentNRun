...
;
;
function AddProductDialog({ open, onOpenChange, onAddProduct }) {
...
function ProductsPage() {
    ...
    const handleAddProduct = (newProduct)=>{
        const productToAdd = {
            ...
            availability: newProduct.stock > 0 ? 'Available' : 'Rented',
            imageUrl: 'https://placehold.co/600x400.png'
        };
        ...
        // Also update the shared data source if other components need it
        // This is a temporary solution for the prototype.
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["products"].push(productToAdd);
    };
...
//# sourceMappingURL=src_3a4d4f1a._.js.map